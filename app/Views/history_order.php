<div class="pagetitle">
      <h1 align="center">Data History Order</h1>
      <nav>
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="<?= base_url('home/dashboard')?>">Home</a></li>
          <li class="breadcrumb-item"><a href="<?= base_url('home/data_order')?>">Data History Order</a></li>
...
<?php foreach ($erwin as $key => $wkwk) { ?>
    ...
    function updateCountdown<?= $key + 1 ?>() {
        ...
        if (selisih <= 0) {
            countdownElement.innerHTML = "Status Selesai";
